      ...
      <div className="min-h-screen bg-cyber-gradient flex items-center justify-center px-4">
        ...
        >
          ...
          <button 
            ...
            className="px-6 py-3 rounded-lg bg-gradient-to-r from-cyber-teal to-electric-purple text-white font-semibold hover:shadow-neon-teal transition-shadow duration-300"
          >
            Connect Wallet
          </button>
        </motion.div>
